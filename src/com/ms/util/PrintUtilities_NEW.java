 ...
 * @author TRANSDYN\ery
 */
public class PrintUtilities_NEW implements Printable {

    private Component componentToBePrinted;

    public static void printComponent(Component c) {
        new PrintUtilities_NEW(c).print();
    }

    public PrintUtilities_NEW(Component componentToBePrinted) {
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) {
        ...
        if (pageIndex > 0) {
            ...
            g2d.translate(pageFormat.getImageableX(), pageFormat.getImageableY());// - 220
            disableDoubleBuffering(componentToBePrinted);
            // scale to fill the page          
            double dw = pageFormat.getImageableWidth() - 180;
